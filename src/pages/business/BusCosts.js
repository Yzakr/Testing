...
<div className="general__background">
         <div className="chooseDash__container">
            <h1 className="marginTop__onMobile--4rem">Dobcon Business per Total Initiative Cost</h1>
            ...
            <div className="business__dropdown">
               <div className="dropdownBtn">Total Initiative Cost<i class="fas fa-chevron-down"></i></div>
            ...
            <div className="filter__container">
               ...
               <span className='filter__btn small__btn'>Greater than | <button className='red__btn'><i className="fas fa-times"></i></button></span>

               <span className='filter__btn small__btn'>Lower than | <button className='red__btn'><i className="fas fa-times"></i></button></span>
