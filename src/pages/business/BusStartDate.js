   ...
   return (
      <div className="general__background">
         <div className="chooseDash__container">
            <h1 className="marginTop__onMobile--4rem">Dobcon Business per Date</h1>
            ...
            <br />
               ...
               <div className="business__dropdown">
                  <div className="dropdownBtn">Initiative Start Date<i class="fas fa-chevron-down"></i></div>
               ...
               <div className="filter__container">
                  ...
                  <span className='filter__btn small__btn'>Is equal to | <button className='red__btn'><i className="fas fa-times"></i></button></span>

                  <span className='filter__btn small__btn'>Is before | <button className='red__btn'><i className="fas fa-times"></i></button></span>

                  <span className='filter__btn small__btn'>Is after | <button className='red__btn'><i className="fas fa-times"></i></button></span>

                  <span className='filter__btn small__btn'>Is between | <button className='red__btn'><i className="fas fa-times"></i></button></span>
         ...
         <div className="initiatives__container">
            ...
            <Link to="#" className="initiative__btn">Initiative Y</Link>
