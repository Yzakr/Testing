   ...
   return (
      <div className="general__background">
         <div className="chooseDash__container">
            <h1 className="marginTop__onMobile--4rem">Dobcon Business per Location</h1>
            ...
            <div className="business__dropdown">
               <div className="dropdownBtn">Location<i class="fas fa-chevron-down"></i></div>
            ...
            <div className="filter__container">
               ...
               <span className='filter__btn small__btn'>Location 1 | <button className='red__btn'><i className="fas fa-check"></i></button></span>

               <span className='filter__btn small__btn'>Location 2 | <button className='red__btn'><i className="fas fa-check"></i></button></span>
